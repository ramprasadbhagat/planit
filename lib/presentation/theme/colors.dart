...
abstract class AppColors {
  ...
  static const Color unselectedIndicatorColor =
  ...
  static const Color neutralsDarkBlack = Color.fromRGBO(31, 31, 31, 1);
  ...
  static const Color neutralsGrey1 = Color.fromRGBO(99, 99, 99, 1);
  ...
  static const Color deepRed = Color.fromRGBO(167, 22, 0, 1);
  static const Color darkerGrey = Color.fromRGBO(101, 101, 101, 1);
  ...
  static const Color returnSummaryStatusTextColor =
      Color.fromRGBO(98, 98, 98, 98);

  static const Color boxShadowGray = Color.fromRGBO(0, 0, 0, 0.06);
  ...
  static const Color secondaryMustard = Color.fromRGBO(245, 219, 181, 1);
  static const Color grayishBlue = Color.fromRGBO(222, 227, 230, 1);
  ...
  static const Color bestDiscountTextBg = Color.fromRGBO(104, 153, 58, 1);
  static const Color bestDiscountBG = Color.fromRGBO(240, 245, 235, 1);
  ...
  static const Color redButton = Color(0xFFC11A1A);
