...
class _$UserStateImpl implements _UserState {
  ...
  @override
  String toString() {
    return 'UserState(isFetching: $isFetching, apiFailureOrSuccessOption: $apiFailureOrSuccessOption, user: $user)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isFetching, apiFailureOrSuccessOption, user);
...
abstract class _UserState implements UserState {
  const factory _UserState(
      ...
      required final Option<Either<ApiFailure, dynamic>>
          apiFailureOrSuccessOption,
      required final CurrentUser user}) = _$UserStateImpl;
