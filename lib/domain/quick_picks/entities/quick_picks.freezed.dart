...
/// @nodoc
abstract class $QuickPicksCopyWith<$Res> {
  factory $QuickPicksCopyWith(
          QuickPicks value, $Res Function(QuickPicks) then) =
      _$QuickPicksCopyWithImpl<$Res, QuickPicks>;
  @useResult
  $Res call(
      {String id,
      String categoryId,
...
/// @nodoc
class _$QuickPicksCopyWithImpl<$Res, $Val extends QuickPicks>
    implements $QuickPicksCopyWith<$Res> {
  _$QuickPicksCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$QuickPicksImplCopyWith<$Res>
    implements $QuickPicksCopyWith<$Res> {
  factory _$$QuickPicksImplCopyWith(
          _$QuickPicksImpl value, $Res Function(_$QuickPicksImpl) then) =
      __$$QuickPicksImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$QuickPicksImplCopyWithImpl<$Res>
    extends _$QuickPicksCopyWithImpl<$Res, _$QuickPicksImpl>
    implements _$$QuickPicksImplCopyWith<$Res> {
  __$$QuickPicksImplCopyWithImpl(
      _$QuickPicksImpl _value, $Res Function(_$QuickPicksImpl) _then)
      : super(_value, _then);
...
class _$QuickPicksImpl extends _QuickPicks {
  const _$QuickPicksImpl(
      {required this.id,
  ...
  _$$QuickPicksImplCopyWith<_$QuickPicksImpl> get copyWith =>
      __$$QuickPicksImplCopyWithImpl<_$QuickPicksImpl>(this, _$identity);
}

abstract class _QuickPicks extends QuickPicks {
  const factory _QuickPicks(
