...
part of 'wish_list_product.dart';
...
abstract class _WishlistProduct extends WishlistProduct {
  factory _WishlistProduct(
      ...
      required final bool isActive}) = _$WishlistProductImpl;
  _WishlistProduct._() : super._();
