...
SimilarProductDto _$SimilarProductDtoFromJson(Map<String, dynamic> json) {
  return _SimilarProductDto.fromJson(json);
}

/// @nodoc
mixin _$SimilarProductDto {
  ...
  @JsonKey(ignore: true)
  $SimilarProductDtoCopyWith<SimilarProductDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SimilarProductDtoCopyWith<$Res> {
  factory $SimilarProductDtoCopyWith(
          SimilarProductDto value, $Res Function(SimilarProductDto) then) =
      _$SimilarProductDtoCopyWithImpl<$Res, SimilarProductDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SimilarProductDtoCopyWithImpl<$Res, $Val extends SimilarProductDto>
    implements $SimilarProductDtoCopyWith<$Res> {
  _$SimilarProductDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SimilarProductDtoImplCopyWith<$Res>
    implements $SimilarProductDtoCopyWith<$Res> {
  factory _$$SimilarProductDtoImplCopyWith(_$SimilarProductDtoImpl value,
          $Res Function(_$SimilarProductDtoImpl) then) =
      __$$SimilarProductDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(defaultValue: '') String id,
...
/// @nodoc
class __$$SimilarProductDtoImplCopyWithImpl<$Res>
    extends _$SimilarProductDtoCopyWithImpl<$Res, _$SimilarProductDtoImpl>
    implements _$$SimilarProductDtoImplCopyWith<$Res> {
  __$$SimilarProductDtoImplCopyWithImpl(_$SimilarProductDtoImpl _value,
      $Res Function(_$SimilarProductDtoImpl) _then)
      : super(_value, _then);
...
class _$SimilarProductDtoImpl extends _SimilarProductDto {
  ...
  factory _$SimilarProductDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$SimilarProductDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'SimilarProductDto(id: $id, productName: $productName, productDescription: $productDescription, sku: $sku, skuPrice: $skuPrice, startingPrice: $startingPrice, productMRP: $productMRP, productReview: $productReview, productRating: $productRating, ingredientsList: $ingredientsList, nutritionalInformation: $nutritionalInformation, isDeleted: $isDeleted, isActive: $isActive, isHighlighted: $isHighlighted, isQuickPick: $isQuickPick, discount: $discount, attributeName: $attributeName, attributeItem: $attributeItem, attributeItemId: $attributeItemId, attributeItemProductId: $attributeItemProductId, price: $price, productImages: $productImages, backOrder: $backOrder, inventoryList: $inventoryList)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SimilarProductDtoImplCopyWith<_$SimilarProductDtoImpl> get copyWith =>
      __$$SimilarProductDtoImplCopyWithImpl<_$SimilarProductDtoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SimilarProductDtoImplToJson(
      this,
    );
  }
}
...
abstract class _SimilarProductDto extends SimilarProductDto {
  const factory _SimilarProductDto(
      ...
      required final List<InventoryDto>
          inventoryList}) = _$SimilarProductDtoImpl;
  const _SimilarProductDto._() : super._();

  factory _SimilarProductDto.fromJson(Map<String, dynamic> json) =
      _$SimilarProductDtoImpl.fromJson;
